...
namespace Test.ViewModels
{
    public class RegisterUserViewModel
    {
        ...
        //custom validation
        [Remote("CheckUserNameUnique", "Account", AdditionalFields = "UserId", ErrorMessage = "UserName already exists, please select another name!!.")]
        ...
        [Required(ErrorMessage = "Please,upload the UserNameImage")]
        [Display(Name = "UserNameImage")]
